...
# load data
raw_data = pd.read_csv('C:/Users/placi/OneDrive/Documents/Online-Realtime-Action-Recognition-based-on-OpenPose-master/Online-Realtime-Action-Recognition-based-on-OpenPose-master/Action/training/data_under_scene.csv', header=0)
